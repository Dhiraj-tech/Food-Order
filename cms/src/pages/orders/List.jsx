    ...
    <Row>
        <Col xs="12">
            ...
            <Row>
                <Col xs="12">
                    { loading ?
                        <Loading/>: <DataTable searchable={['Name', 'Phone', 'Address', 'Details',
                        'Status', 'Created At', 'Updated At']} sortable={
                        ['Name', 'Phone', 'Address', 'Details', 'Status', 'Created At', 'Updated At']} data={orders.map(order => {
                            return {
                                'Name': order.user[0].name,
                                'Phone': order.user[0].phone,
                                'Address': order.user[0].address,
                                'Details': <ul>
