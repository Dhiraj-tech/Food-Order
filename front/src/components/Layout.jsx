                  ...
                  <ul className="top-nav">
                    ...
                    <li>
                      <a href="mailto:mail@ecom.com">
                        <i className="fa fa-envelope me-2"></i>foodlogy@mail.net
                      </a>
                    </li>
                  </ul>
                </div>
        ...
        <footer className="gap no-bottom" id="foot">
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="menu contacts">
                  ...
                  <Link to="#">
                    <i className="fa-solid fa-envelope"></i>foodlogy@mail.net
                  </Link>
                  <Link to="#">
            ...
            <div className="footer-two gap no-bottom">
              <p>Copyright © 2024. Foodlogy. All rights reserved.</p>
